...
lab7pkg_pick_place/lab7_ur3e.py
...
class UR3e():
    ...
    def __init__(self):
        ...
        # define a ROS publisher for /ur3e_driver_ece470/setio message with buffer size of 10
        # self.pub_setio =
        ...
        # define a ROS subscriber for /ur_hardware_interface/io_states message and corresponding callback function
        # self.sub_io =
    ...
    def gripper_input_callback(self, msg):
        """
        define a ROS topic callback function for getting the state of suction cup
    ...
    def position_callback(self, msg):
        """
        define a ROS topic callback function for getting the current position of the arm
    ...
    def gripper(self, io_0):
        """
        define a function for ROS Publisher to publish your message to the Topic "ur3e_driver_ece470/setio",
    ...
    def move_block(self, start_loc, start_height, end_loc, end_height):
        """
        define move_block function which is used to move a block from start to end location
